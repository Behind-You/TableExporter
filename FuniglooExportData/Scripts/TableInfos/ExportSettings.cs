...
namespace FuniglooExportData
{
    public class ExportSetting
    {
        ...
        //public readonly List<string> CombinRanges;
        public readonly List<(string SheetName, string Range)> CombinRanges;
        ...
        public ExportSetting(List<CellData> datas)
        {
            ...
            CombinRanges = new List<(string SheetName, string Range)>();
            ...
            for (int i = (int)ExportParameter.COMBINE_RANGES; i < CombineCount + (int)ExportParameter.COMBINE_RANGES; ++i)
            {
                ...
                if (val.Length == 1)
                    CombinRanges.Add((null, val[0]));
                else
                    CombinRanges.Add((val[0], val[1]));
            }
        }
